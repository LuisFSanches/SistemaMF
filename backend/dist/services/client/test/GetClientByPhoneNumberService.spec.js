...
// src/services/client/test/GetClientByPhoneNumberService.spec.ts
vi.mock("../../../prisma", () => ({
  default: mockDeep()
}));
describe("GetClientByPhoneNumberService", () => {
  ...
  it("should find a client by phone number successfully", async () => {
    ...
    prisma_default.client.findFirst.mockResolvedValue(mockClient);
    const result = await service.execute("123456789");
    globalExpect(prisma_default.client.findFirst).toHaveBeenCalledWith({
      where: {
        phone_number: "123456789"
      }
    });
    globalExpect(result).toEqual(mockClient);
  });
  it("should return null when client is not found", async () => {
    prisma_default.client.findFirst.mockResolvedValue(null);
  ...
  it("should return null when phone_number is empty", async () => {
    ...
    globalExpect(prisma_default.client.findFirst).not.toHaveBeenCalled();
    globalExpect(result).toBeNull();
  });
