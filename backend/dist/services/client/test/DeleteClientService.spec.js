...
// src/services/client/test/DeleteClientService.spec.ts
vi.mock("../../../prisma", () => ({
  default: mockDeep()
}));
describe("DeleteClientService", () => {
  ...
  it("should delete a client successfully", async () => {
    ...
    prisma_default.client.delete.mockResolvedValue({
      id: clientId,
      first_name: "John",
      last_name: "Doe",
    ...
    globalExpect(prisma_default.client.delete).toHaveBeenCalledWith({
      where: {
        id: clientId
      }
    });
    globalExpect(result).toEqual({ Status: "Client successfully deleted" });
  });
});
