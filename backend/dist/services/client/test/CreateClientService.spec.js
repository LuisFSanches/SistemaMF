...
// src/services/client/test/CreateClientService.spec.ts
vi.mock("../../../prisma", () => ({
  default: mockDeep()
}));
describe("CreateClientService", () => {
  ...
  it("should create a client successfully", async () => {
    ...
    prisma_default.client.create.mockResolvedValue(mockCreatedClient);
    const result = await service.execute({
      first_name: "John Doe",
      last_name: "Doe",
      phone_number: "123456789"
    });
    globalExpect(prisma_default.client.create).toHaveBeenCalledWith({
      data: {
        first_name: "John Doe",
        last_name: "Doe",
        phone_number: "123456789"
    ...
    globalExpect(result).toEqual(mockCreatedClient);
  });
});
