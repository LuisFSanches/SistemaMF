...
// src/services/client/test/UpdateClientService.spec.ts
vi.mock("../../../prisma", () => ({
  default: mockDeep()
}));
describe("UpdateClientService", () => {
  ...
  it("should update a client successfully", async () => {
    ...
    prisma_default.client.update.mockResolvedValue(mockUpdatedClient);
    ...
    globalExpect(prisma_default.client.update).toHaveBeenCalledWith({
      where: {
        id: "abc123"
      },
      data: {
    ...
    globalExpect(result).toEqual(mockUpdatedClient);
  });
