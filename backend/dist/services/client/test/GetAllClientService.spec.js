...
// src/services/client/test/GetAllClientService.spec.ts
vi.mock("../../../prisma", () => ({
  default: mockDeep()
}));
describe("GetAllClientService", () => {
  ...
  it("should get all clients with default pagination", async () => {
    ...
    prisma_default.client.findMany.mockResolvedValue(mockClients);
    prisma_default.client.count.mockResolvedValue(2);
    const result = await service.execute();
    globalExpect(prisma_default.client.findMany).toHaveBeenCalledWith({
      where: {},
      skip: 0,
      take: 10
    });
    globalExpect(prisma_default.client.count).toHaveBeenCalled();
  ...
  it("should get clients with custom pagination", async () => {
    ...
    prisma_default.client.findMany.mockResolvedValue(mockClients);
    prisma_default.client.count.mockResolvedValue(25);
  ...
  it("should filter clients by query string", async () => {
    ...
    prisma_default.client.findMany.mockResolvedValue(mockClients);
    prisma_default.client.count.mockResolvedValue(1);
  ...
  it("should handle empty results", async () => {
    prisma_default.client.findMany.mockResolvedValue([]);
    prisma_default.client.count.mockResolvedValue(0);
    const result = await service.execute();
    globalExpect(result).toEqual({
      users: [],
      total: 0,
