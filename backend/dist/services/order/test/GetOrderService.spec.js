...
// src/services/order/test/GetOrderService.spec.ts
vi.mock("../../../prisma", () => ({
  default: mockDeep()
}));
describe("GetOrderService", () => {
  ...
  it("should return an order", async () => {
    const mockedOrder = {
      ...
      status: "PENDING",
      createdAt: /* @__PURE__ */ new Date("2023-08-01T15:00:00.000Z"),
      updatedAt: /* @__PURE__ */ new Date("2023-08-01T15:00:00.000Z"),
      card_message: null,
      card_from: null,
      card_to: null,
      ...
      created_at: /* @__PURE__ */ new Date("2023-08-01T15:00:00.000Z"),
      updated_at: /* @__PURE__ */ new Date("2023-08-01T15:00:00.000Z")
    };
    prisma.order.findFirst.mockResolvedValue(mockedOrder);
    const result = await getOrderService.execute(mockedOrder.id);
    globalExpect(prisma.order.findFirst).toHaveBeenCalledWith({
      where: {
        id: mockedOrder.id
      }
    });
    globalExpect(result).toEqual(mockedOrder);
  });
});
