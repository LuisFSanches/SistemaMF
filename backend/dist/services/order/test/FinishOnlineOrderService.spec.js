...
// src/services/order/test/FinishOnlineOrderService.spec.ts
...
vi.mock("moment-timezone", () => ({
  default: {
    ...
    toDate: vi.fn(() => /* @__PURE__ */ new Date("2023-08-01T15:00:00.000Z"))
  }
}));
describe("FinishOnlineOrderService", () => {
  let finishOnlineOrderService;
  beforeEach(() => {
  ...
  it("should finish an online order", async () => {
    ...
    const mockOnlineOrder = {
      ...
      delivery_date: /* @__PURE__ */ new Date("2023-08-01T15:00:00.000Z"),
      status: "pending",
      has_card: false,
    ...
    const mockedUpdatedOrder = {
      ...
      is_delivery: true,
      delivery_date: /* @__PURE__ */ new Date("2023-08-01T15:00:00.000Z"),
      created_at: /* @__PURE__ */ new Date("2023-08-01T10:00:00.000Z"),
      updated_at: /* @__PURE__ */ new Date("2023-08-01T10:00:00.000Z"),
      card_message: null,
      card_from: null,
      card_to: null,
      client: {
        ...
        created_at: /* @__PURE__ */ new Date("2023-07-01T10:00:00.000Z"),
        updated_at: /* @__PURE__ */ new Date("2023-07-01T10:00:00.000Z")
      },
      clientAddress: {
        id: "456",
        client_id: "123",
    ...
    const mockedFormattedDeliveryDate = import_moment_timezone2.default.utc(mockOnlineOrder.delivery_date).tz("America/Sao_Paulo", true).set({ hour: 12, minute: 0, second: 0 }).toDate();
    prisma_default.order.update.mockResolvedValue(mockedUpdatedOrder);
    const result = await finishOnlineOrderService.execute(mockOnlineOrder);
    globalExpect(prisma_default.order.update).toHaveBeenCalledWith({
      where: {
    ...
    globalExpect(result).toEqual(mockedUpdatedOrder);
  });
});
