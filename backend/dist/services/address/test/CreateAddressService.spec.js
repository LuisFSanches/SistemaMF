...
// src/services/address/test/CreateAddressService.spec.ts
vi.mock("../../../prisma", () => ({
  default: mockDeep()
}));
describe("CreateAddressService", () => {
  ...
  it("should create an address successfully", async () => {
    ...
    prisma_default.address.create.mockResolvedValue(mockCreatedAddress);
    const service = new CreateAddressService();
    const result = await service.execute(mockAddressData);
    globalExpect(prisma_default.address.create).toHaveBeenCalledWith({ data: mockAddressData });
    globalExpect(result).toEqual(mockCreatedAddress);
  });
});
