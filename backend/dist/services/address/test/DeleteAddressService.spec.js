...
// src/services/address/test/DeleteAddressService.spec.ts
vi.mock("../../../prisma", () => ({
  default: mockDeep()
}));
describe("DeleteAddressService", () => {
  ...
  it("should delete address successfully", async () => {
    ...
    prisma_default.address.delete.mockResolvedValue(mockDeletedAddress);
    const service = new DeleteAddressService();
    const result = await service.execute(mockId);
    globalExpect(prisma_default.address.delete).toHaveBeenCalledWith({ where: { id: mockId } });
    globalExpect(result).toEqual({ Status: "Address successfully deleted" });
  });
});
