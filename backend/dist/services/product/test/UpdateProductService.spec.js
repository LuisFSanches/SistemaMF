...
// src/services/product/test/UpdateProductService.spec.ts
vi.mock("../../../prisma", () => ({
  default: mockDeep()
}));
describe("UpdateProductService", () => {
  ...
  it("should update a product successfully", async () => {
    ...
    prisma_default.product.update.mockResolvedValue(mockUpdatedProduct);
    ...
    globalExpect(prisma_default.product.update).toHaveBeenCalledWith({
      where: {
        id: "abc123"
      },
      data: {
    ...
    globalExpect(result).toEqual(mockUpdatedProduct);
  });
  ...
  it("should return error object if Prisma throws an exception", async () => {
    ...
    prisma_default.product.update.mockRejectedValue(new Error(errorMessage));
    try {
