...
// src/services/product/test/CreateProductService.spec.ts
vi.mock("../../../prisma", () => ({
  default: mockDeep()
}));
describe("CreateProductService", () => {
  ...
  it("should create a product successfully", async () => {
    ...
    prisma_default.product.create.mockResolvedValue(mockCreatedProduct);
    ...
    globalExpect(prisma_default.product.create).toHaveBeenCalledWith({
      data: {
        name: "Test Product",
        price: 29.99,
        unity: "kg",
    ...
    globalExpect(result).toEqual(mockCreatedProduct);
  });
  ...
  it("should return error object if Prisma throws an exception", async () => {
    ...
    prisma_default.product.create.mockRejectedValue(new Error(errorMessage));
    try {
