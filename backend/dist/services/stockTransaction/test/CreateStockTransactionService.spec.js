...
// src/services/stockTransaction/test/CreateStockTransactionService.spec.ts
vi.mock("../../../prisma", () => ({
  default: mockDeep()
}));
vi.mock("moment-timezone", () => {
  const mockMoment = {
    ...
    toDate: vi.fn(() => /* @__PURE__ */ new Date("2023-01-01T12:00:00.000Z"))
  };
  const moment2 = Object.assign(vi.fn(() => mockMoment), {
...
describe("CreateStockTransactionService", () => {
  ...
  it("should create a stock transaction successfully", async () => {
    const mockCreatedTransaction = {
      ...
      unity_price: 10.5,
      total_price: 1050,
      purchased_date: /* @__PURE__ */ new Date("2023-01-01T12:00:00.000Z"),
      created_at: /* @__PURE__ */ new Date(),
      updated_at: /* @__PURE__ */ new Date()
    };
    prisma_default.stockTransaction.create.mockResolvedValue(mockCreatedTransaction);
    ...
    globalExpect(prisma_default.stockTransaction.create).toHaveBeenCalledWith({
      data: {
        product_id: "product123",
        supplier: "Test Supplier",
        unity: "kg",
    ...
    globalExpect(result).toEqual(mockCreatedTransaction);
  });
